...
class _TabPendientesState extends State<TabPendientes> {
  ...
  Future<void> reintentarEnvio(
    ...
    try {
      ...
      if (res['error'] == false && resWF['error'] == false) {
        ...
        // Actualizar el estado y mostrar una alerta
        setState(() {
          showPedidosRezagados = false;
        });

        // Mostrar la alerta y obtener pedidos sin completar
  ...
  List<List<Map<String, dynamic>>> groupByValue(List<dynamic> arr, String key) {
    // Usamos un mapa para agrupar los valores
    Map<dynamic, List<Map<String, dynamic>>> groupedMap = {};

    // Recorremos la lista y agrupamos los valores por la clave especificada
    for (var curr in arr) {
    ...
    // Convertimos el mapa en una lista de listas
    return groupedMap.values.toList();
  }
              ...
              child: Card(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemCount:
                                1, // Assuming you have only one icon to show
                            itemBuilder: (context, iconIndex) {
                              return Icon(
                                Icons
                                    .timelapse_outlined, // Assuming the icon is a clock
                                size: 20.0,
                              );
                            },
                          ),
                    ...
                    SizedBox(height: 4.0),
                    /*
                    if (item?['meta'] != null && meta['tipoServicio'] != null)
                      Container(
                        ...
                        child: Text(
                          meta['tipoServicio'].toString() ??
                              "", // Asegúrate de que el valor es un String
                          style: TextStyle(color: Colors.white, fontSize: 10),
                          textAlign: TextAlign.center,
                        ),
                      ),
                    if (item?['meta'] != null && meta?['estadoPago'] != null)
                      Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: null, //finalizarRutaGeneral,
